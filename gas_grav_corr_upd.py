...
if co2_comp <= 0.02 or n2_comp <= 0.03 or h2s_comp <= 0:
    ...
    print('The corrected gas gravity is {0:.2f} '.format(gas_gravity))
...
#computing psuedo-pressure and psuedo-temperature for the entire mixture
...
print('The hydrocarbon psuedo-pressure is {0:.2f} psia'.format (p_pc))
print('The hydrocarbon psuedo-temperature is {0:.2f} deg Rankine'.format (t_pc))
